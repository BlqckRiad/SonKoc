...
namespace YksProject.DataAccessLayer.EntityFramework
{
    ...
    public class EfTamamlanmisKonularDal : GenericRepository<TamamlanmisKonular>, ITamamlanmisKonularDal
    {
        public EfTamamlanmisKonularDal(Context context) : base(context)
        {
